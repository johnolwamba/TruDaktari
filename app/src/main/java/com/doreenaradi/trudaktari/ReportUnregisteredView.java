...
public class ReportUnregisteredView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_report_unregistered_view);
        ...
        btnSelectLocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    startActivityForResult(builder.build(ReportUnregisteredView.this), PLACE_PICKER_REQUEST);
    ...
    private class addReport extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(ReportUnregisteredView.this);
